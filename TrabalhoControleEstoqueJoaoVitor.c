...
void armazenarMovimentacao(TipoLista_movim *lista_movimentacoes, reg_movim conteudoMovimentacao) {
    ...
    // Preenche o conteúdo da nova movimentação
    novo_item->conte_Movim = conteudoMovimentacao;
    ...
    gotoxy(3, 06);
    printf("Digite a data da movimentacao (formato DD/MM/AAAA): ");
    scanf("%s", novo_item->conte_Movim.dt_Movim);

    gotoxy(3, 07);
    printf("Digite o tipo da movimentacao: ");
    scanf("%s", novo_item->conte_Movim.tp_Movim);

    gotoxy(3, 8);
    printf("Digite a quantidade da movimentacao: ");
    scanf("%d", &novo_item->conte_Movim.qt_Movim);
...
void telaMenuMovimentacao(TipoLista_movim *lista_movimentacoes) {
    ...
    do {
        ...
        switch (opc4) {
            case 1:
                armazenarMovimentacao(lista_movimentacoes, conteudoMovimentacao);
                break;
            case 2:
                break;
            case 3:
